...
namespace AutoLevelUp
{
    class Program
    {
        ...
        {
            get { return ObjectManager.GetLocalPlayer(); }
        }

        public static int Delay
        {
            get { return Menu["delay"].As<MenuSlider>().Value; }
        }
        ...
        private static void OnLoad()
        {
            ...
            {
                Menu.Add(new MenuSlider("delay", "Max. Delay", 1000, 1, 10000));
                Menu.Attach();
            }

            var smite = Player.SpellBook.Spells.Where(o =>o != null && o.SpellData != null).FirstOrDefault(o => o.SpellData.Name == "SummonerSmite");
            ...
            switch (Player.ChampionName)
            {
                ...
                case "Caitlyn":
                    ...
                    break;
                case "Camille":
                    AbilitySequence = new[] { 2, 1, 3, 3, 2, 4, 3, 3, 3, 1, 4, 1, 1, 1, 2, 4, 2, 2 };
                    break;                    
                case "Cassiopeia":
        ...
        private static void Game_OnUpdate()
        {
            try
            {
                ...
                */
                ...
                for (var i = 1; i <= ObjectManager.GetLocalPlayer().Level; i++)
                {
        ...
        {
            DelayAction.Queue(new Random().Next(0, Delay), () =>
